...
function corePlank(level) {
  var hold = level === "ss" ? "60 秒" : level === "s" ? "45 秒" : "30 秒";
  var step =
    level === "ss"
      ? "入门 30 秒，每档 +15 秒，本档 60 秒"
      : level === "s"
        ? "入门 30 秒，本档 +15 秒为 45 秒"
        : "入门 30 秒";
  return {
    name: "平板支撑",
    dose: "3–4 组 × " + hold,
    ...
    coachDose:
      ...
      "。默认 3 组 × " +
      hold +
      "，体能好者 4 组。组间走动 30–40 秒。中途变形立刻跪姿续完。"
  };
}
    ...
    return {
      ...
      student: {
        knowledge: [
          ...
          "平板按秒计时：入门 30 秒，每升一档加 15 秒（本课 30 秒）。撑不住可跪姿",
          "其余项目 3 组按 15 → 20 → 15 次/步，或 4 组 15 → 20 → 25 → 20；动物爬行以熊爬为主，不比谁快"
        ],
      ...
      coach: {
        objectives: {
          knowledge: "知道本课 7 项；平板入门 30 秒、每档 +15 秒；其余动作用 15–20–15 或 15–20–25–20 金字塔。",
          skill: "能完成跪姿或标准平板约 30 秒一条线，小燕飞手脚离垫，熊爬背平。",
        ...
        flow: {
          ...
          special:
            "按表顺序整班完成 7 项。平板 3–4 组 × 30 秒（入门；变形即跪姿）。其余默认 3 组金字塔 15–20–15（爬行为步）；体能好的班改 4 组 15–20–25–20。组间走动。1 年级双抬腿可屈膝，转体双脚点地。",
        ...
        intensityNote:
          "1 年级平板可跪姿，撑不满 30 秒就跪姿续完；其余金字塔可改 10–15–10。2–3 年级按表。全程禁止负重与互相加压。"
      }
    };
  })(),
    ...
    return {
      ...
      student: {
        knowledge: [
          ...
          "平板按秒计时：入门 30 秒，本档 45 秒（+15 秒）",
          "其余项目 3 组按 15 → 20 → 15 次/步，或 4 组 15 → 20 → 25 → 20；跪姿俯卧撑要斜线一条，箭步走膝对脚尖"
        ],
        drills: drills.student,
      ...
      coach: {
        objectives: {
          ...
          skill: "多数完成伸膝平板约 45 秒、跪姿俯卧撑完整次数、箭步走不内扣。",
        ...
        flow: {
          ...
          special:
            "按表 9 项顺序。平板 3–4 组 × 45 秒，能伸膝则伸膝，变形即跪姿续完。其余默认 3 组 15–20–15，体能好者 4 组 15–20–25–20。箭步走分道，一组走完走回。",
    ...
    return {
      ...
      student: {
        knowledge: [
          ...
          "平板按秒计时：入门 30 秒，本档 60 秒（每档 +15 秒）",
          "其余项目 3 组按 20 → 25 → 20 次，或 4 组 20 → 25 → 25 → 20；俯卧撑做不了立刻改跪姿接满；深蹲跳落地要轻；交替肘撑左右落下再撑起算 1 次"
        ],
        drills: drills.student,
      ...
      coach: {
        objectives: {
          ...
          skill: "多数完成标准俯卧撑与约 60 秒平板；深蹲跳轻落地；交替肘撑髋不大幅左右晃。",
        ...
        flow: {
          ...
          special:
            "按表 9 项。平板 3–4 组 × 60 秒。其余默认 3 组 20–25–20，体能好者 4 组 20–25–25–20。深蹲跳放在转体之后、卷腹之前，落地无声。交替肘撑放最后，做不稳改跪姿交替或普通平板计时接满该组秒数。",
